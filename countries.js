// Liste des pays : code ISO (pour flag-icons), nom FR, nom EN
// Triée alphabétiquement sur le nom français
// 'other' est un cas spécial géré séparément dans script.js (champ libre)
const COUNTRIES = [
...
// Option spéciale "Autre / Other" — ajoutée à la fin de la liste affichée
const OTHER_COUNTRY = { code: "other", fr: "Autre", en: "Other" };